package com.gestionclinique.gatewayservice.config;
...
public class SecurityConfig {
        ...
        http
            ...
            .authorizeExchange(exchanges -> exchanges
                .pathMatchers("/swagger-ui/**",
                        ...
                        "/api/v1/users/access/**", "/api/v1/transactions/paytech/ipn").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfig.addAllowedOrigin("https://192.168.1.28:3000");
