        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**",
                                "/swagger-resources/**", "/webjars/**", "/swagger-ui.html","/api/v1/localities/centres/**","/api/v1/localities/centres/{centreId}","/api/v1/localities/** ","/api/v1/localities/{localityId}").permitAll()
