package com.gestionvaccination.appointmentservice.config;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**",
                                "/swagger-resources/**", "/webjars/**", "/swagger-ui.html","/api/v1/appointments/{appointmentId}","/api/v1/appointments/{appointmentId}/status").permitAll()
